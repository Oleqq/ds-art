    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'Двухфакторная защита включена. Отсканируйте QR-код или добавьте ключ в приложение-аутентификатор.',
                buttonText: 'Закрыть',
            };
        }
        ...
        return {
            ...
            description:
                'Чтобы завершить настройку, отсканируйте QR-код или введите ключ в приложении-аутентификаторе.',
            buttonText: 'Продолжить',
        };
